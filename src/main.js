...
const LANGS = {
  en: {
    ...
    strings: {
      ...
      headlineEm: 'AI-Sanad',
      deck: 'Your AI Reasoning Strategist. AI-Sanad reasons, challenges, questions your logic, fires back in real time, and delivers a verdict that makes you think harder.',
      ...
      arenaDeck: 'Watch two AI debaters go head-to-head. AI-Sanad reasons one side; you assign the opponent\'s persona. An impartial judge delivers the final verdict.',
